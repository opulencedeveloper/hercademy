  ...
  return (
    <div className="relative max-w-[40rem] h-screen mx-auto scrollbar-hide overflow-y-auto pt-10 pb-2">
      ...
      <section className="px-4 mt-3">
        <p className="text-[16px] font-semibold">Get Certified!</p>
        ...
        <div className="relative w-full flex-shrink-0 rounded-[8px] overflow-hidden mt-3 mb-8">
          <div className="h-[197px] bg-green-200 w-full overflow-hidden">
            <Image
          ...
          <div className="w-full bg-secondaryShade1 pt-3 pb-2 px-3">
            <div className="flex space-x-1.5 mb-0.5 w-1/3">
              ...
              <p className="text-[10px]">Hertechtrail</p>
            </div>
            ...
            <div className="flex items-center gap-1.5 mt-0.5">
              ...
              <div className="flex-shrink-0 h-[3px] w-[3px] rounded-full bg-primaryShade3"></div>
              <p className="text-[10px]">3 weeks</p>
            </div>
          </div>
